      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Deactivated List</li>
          </ol>
        </section>
                    ...
                    <thead>
                      <tr>
                         <th>Sl No.</th>
                          ...
                          <?php
                       $serial = 0;
                foreach($deact_user_list as $member_data)
                {
                ?>
                    <tbody>
                      <tr>
                          ...
                          <td><?php echo $member_data->dob;?></td>
                          <td><?php echo $member_data->email;?></td>
                          <td><?php echo $member_data->deactivate_days;?></td>
