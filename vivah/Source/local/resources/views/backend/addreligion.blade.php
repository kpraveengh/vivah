          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" id="add_religion">
                  <div class="box-body">
...
$(document).ready(function(){
 ...
 jQuery.extend(jQuery.validator.messages, {
		...
		submitHandler: function(form) {
  		...
  		var value =$("#add_religion").serialize() ;
 

		$.ajax({
		type:'POST',
        url: "{{ url('admin/insert-religion') }}",
		data: value,
		success:function (add_religion){
        $(".message").show();  
        console.log(add_religion);
												
            if(add_religion==1)
            {
				
          window.location="{{ url('admin/religion-list') }}";
