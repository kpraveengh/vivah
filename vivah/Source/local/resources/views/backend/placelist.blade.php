                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                     ...
                     foreach($placelist as $place_list)
                      {
                      $id=$place_list->district_id; 
                         
                      ?>      
                   
                      <tr>
                          <td><?php echo $serial++;?></td>
                          <td><?php echo $place_list->country;?></td>
                          <td><?php echo $place_list->state;?></td>
                           <td><?php echo $place_list->district;?></td>
                        <td><a href='place-list-edit/{{$id}}'>
                        <p class="fa fa-edit"> Edit </p>
                        </a> &nbsp; <a href="#" place_id="<?php echo $place_list->state_id; ?>" class="place_delete" >
...
jQuery(function ($) {
 $(document).on('click', '.place_delete', function () {
							...
							if(r==true){
								var value =$(this).attr('place_id') ;
								$.ajax({
									   url: "{{ url('admin/place-delete') }}",
									   method:'get',
									   data:{'id':value},
									   success:function(placedel){
                       $(".delete_show").show();
