            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                // var_dump($dtls);
                  ...
                  foreach($dtls_ad as $adv_list)
                {
                ?>
                   <form  id="ad_edit" action="{{URL::to('admin/edit-upload-ad')}}" method="post"  accept-charset="UTF-8" >    
            
             <input type="hidden" name="id"  value="<?php echo $adv_list->id;?>" >
                  <div class="box-body">
                    <div class="form-group">
                      <label>Advertisement Name</label>
                      <input type="text" class="form-control" name="ad_name" placeholder="Advertisement name" value="<?php echo $adv_list->ad_name;?>"   required>
                    </div>
                      ...
                      <div class="col-sm-6 text-right">
                                               ...
                                               <img src="{{asset($adv_list->ad_image)}} ">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="ad_posted_date"  data-field="date" value="<?php echo $adv_list->ad_posted_date;?>" readonly>
                    </div>
                  ...
                  <div class="box-footer">
                    <button type="submit" name="dataAdImageForm" class="btn btn-primary">Submit</button>
                  </div>
                </form>
                <?php
              }
...
$('#ad_edit').ajaxForm(function(options) { 
