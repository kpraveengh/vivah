          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                ...
                <!-- form start -->
                <form role="form" id="add_star">
                  <div class="box-body">
                    <div class="form-group">
                      <label>Star</label>
                      <input type="text" class="form-control" name="star" placeholder="Enter Star"  required>
                    </div>
...
jQuery.validator.addMethod("accept", function(value, element, param) {
 ...
 jQuery.extend(jQuery.validator.messages, {
		...
		submitHandler: function(form) {
  		...
  		var value =$("#add_star").serialize() ;
 

		$.ajax({
		type:'POST',
        url: "{{ url('admin/insert-star') }}",
		data: value,
		success:function (add_star){
        $(".message").show();  
        console.log(add_star);
          ...
          window.location="{{ url('admin/star-list') }}";
