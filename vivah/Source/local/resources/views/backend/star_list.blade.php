                    ...
                    <thead>
                     ...
                     foreach($starlist as $star)
                      ...
                      <tr>
                          ...
                          <td><?php echo $star->star;?></td>
                          <td><a href='star-list-edit/{{$star_id}}'>
                        <p class="fa fa-edit"> Edit </p>
                        </a> &nbsp;<a href="#" star_id="<?php echo $star->star_id; ?>" class="star_delete" >
...
jQuery(function ($) {
 $(document).on('click', '.star_delete', function () {
							...
							if(r==true){
								var value =$(this).attr('star_id') ;
								$.ajax({
									   url: "{{ url('admin/star-delete') }}",
									   method:'get',
									   data:{'id':value},
									   success:function(stardel){
                       $(".delete_show").show();
									   console.log(stardel);
