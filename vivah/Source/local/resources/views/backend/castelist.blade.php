                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                     ...
                     foreach($castelist as $religion_list)
                      {
                          
                       $casteid=$religion_list->caste_id;  
                      ?>         
                   
                      <tr>
                          <td><?php echo $serial++;?></td>
                          <td><?php echo $religion_list->religion;?></td>
                          <td><?php echo $religion_list->caste;?></td>
                          <td><a href='caste-list-edit/{{$casteid}}'>
                        <p class="fa fa-edit"> Edit </p>
                        </a> &nbsp;<a href="#"  caste_id="<?php echo $religion_list->caste_id; ?>" class="religion_delete" >
