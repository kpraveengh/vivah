...
<div style="width:660px; height:640px; margin:0 auto; background:#16a8d6; padding:20px 20px 20px 20px; font-family: Century Gothic,Verdana,Geneva,sans-serif; border:solid #118ab0 1px;">
	
    <div style="width:100%; float:left; padding:0 0 20px 0;">
    <div style="width:205px; height:71px;  margin:0 auto"> <img src="{{asset($logo)}}"/ ></div>
    </div>
        ...
        <div style="background:#fff;  float:left; width:96.3%;   border-top-right-radius: 8px; border-top-left-radius: 8px; padding:15px 12px 0 12px;  ">
    		<div style="width:100%; padding:10px 0 10px 0; float:left; color:#666261; font-size:14px;"> Welcome to solmate, find your perfect match with us </div>
				...
				<p>Please click on the reset password link to reset your password"</p>
				 
				<p><a href="{{URL::to('user/password-change-page?user_key='.$user_key) }}"> Reset Password</a></p>
            </div>
        </div>
